...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println("kim.name : " + kim.name);	// kim객체의 name 출력
		System.out.println("park.name : " + park.name);	// park객체의 name 출력
		...
		System.out.println("kim.country : " + kim.country);	// kim객체의 country변수 출력
		System.out.println("park.country : " + park.country);	// park객체의 country변수 출력
		// 스태틱 변수는 모든 인스턴스(객체)가 값을 공유하기 때문에
		// 인스턴스가 중요하지 않다 따라서 클래스명.변수명 으로 사용할 수 있다
		System.out.println("Korean.country : " + Korean.country);	// Korean객체의 country변수 출력
